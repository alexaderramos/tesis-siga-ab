...
@section('title')Gestionar Personas @endsection
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            ...
            <a href="{{ route('people.add') }}"><button type="button" class="btn btn-success"  >Crear</button></a>
        </div>
...
<div class="x_panel">
<div class="x_title">
<h2>Personas registradas<small></small></h2>
...
<tr role="row">
    ...
    <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 50px; color:white;" aria-sort="ascending" aria-label="Nombres: activate to sort column descending">Nombre</th>
     <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 50px; color:white;" aria-sort="ascending" aria-label="Nombres: activate to sort column descending">Genero</th>
    ...
    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 10px; color:white;" aria-label="Office: activate to sort column ascending">Fec. Nacimiento</th>
    ...
    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 10px; color:white;" aria-label="Start date: activate to sort column ascending">Profesión</th>
...
<td tabindex="0" class="sorting_1">{{ $people->DNI }}</td>
<td>{{ $people->Name.' '.$people->LastName.' '.$people->MiddleName }}</td>
<td>{{ $people->Gender }}</td>
<td>{{ $people->Phone }}</td>
