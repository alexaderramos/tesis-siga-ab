...
@section('title')  Gestionar grados  @endsection
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>Gestionar grados</h3>
             <a href="{{ route('grades.add') }}"><button type="button" class="btn btn-success"  >Crear Grado</button></a>
        </div>
...
<tr role="row">
    ...
    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width:10px; color:white;" aria-label="Position: activate to sort column ascending">Capacidad</th>
