...
@section('title')Gestionar Periodos @endsection
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>Gestionar periodo</h3>
             <a href="{{ route('period.add') }}"><button type="button" class="btn btn-success"  >Crear Periodo</button></a>
        </div>
