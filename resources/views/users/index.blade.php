...
@section('title') Gestionar Usuarios @endsection
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            ...
            <a href="{{ route('users.create') }}"><button type="button" class="btn btn-success"  >Crear</button></a>
            <a href="{{ route('users.type') }}"><button type="button" class="btn btn-primary"  >Crear nuevo tipo</button></a>
        </div>
...
<tr role="row">
    ...
    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 10px; color:white;" aria-label="Office: activate to sort column ascending">Código</th>
    ...
    <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width:10px; color:white;" aria-label="Position: activate to sort column ascending">Email</th>
...
<td tabindex="0" class="sorting_1">{{ $user->CodUser }}</td>
<td>{{ $user->DNI }}</td>
<td>{{ $user->name }}</td>
<td>{{ $user->email }}</td>
