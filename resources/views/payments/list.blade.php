...
<div class="x_panel">
<div class="x_title">
<h2>Historial pagos por alumno<small></small></h2>
...
<td><button type="button" class="btn btn-info" ><i class="fa fa-eye"  data-toggle="tooltip" title="Ver Pagos" ></i></button></td>
