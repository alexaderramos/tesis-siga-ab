...
@section('title')Registrar docentes  @endsection
@section('content')
<div class="clearfix"></div>
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Registrar docentes <small></small></h2>
        ...
        <div class="clearfix"></div>
                ...
                <div class="x_content">
<form class="form-horizontal form-label-left" novalidate=""  action="{{ route('teachers.index') }}">

{{ csrf_field()  }}

<span class="section">Datos del docente</span>
...
<div class="item form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="estudios">Estudios: <span class="required">*</span>
</label>
<div class="col-md-6 col-sm-6 col-xs-12">
<input value="{{ old('estudios') }}" type="text" id="estudios" name="estudios" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" maxlength="9" placeholder="Ingeniero de sistemas" >
</div>
</div>
