...
@section('title')  Gestionar matrículas  @endsection
@section('content')
	
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Gestionar Matrículas</h3>
            <a href="{{ route('matriculation.add') }}"><button type="button" class="btn btn-success"  >Matricular Alumno</button></a>
        </div>
