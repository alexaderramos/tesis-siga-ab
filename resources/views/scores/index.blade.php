...
@section('content')
 ...
 <div class="page-title">
        <div class="title_left">
            <h3>Registrar notas de alumnos</h3>
...
<div class="x_panel">
<div class="x_title">
<h2>Historial académico por alumno<small></small></h2>
    ...
    <div >
            ...
            <select name="datatable-responsive_length" aria-controls="datatable-responsive" class="form-control input-sm">
                ...
                <option value="Arte">Arte</option>
                     ...
                     <a href="{{ route('scores.addstudents') }}"><button type="button" class="btn btn-success"  >Agregar Notas</button></a>
        </label>
...
<td>17 años</td>
<td>
    <button type="button" class="btn btn-warning" ><i class="fa fa-plus"  data-toggle="tooltip" title="Actualizar notas" ></i></button>
    <button type="button" class="btn btn-info" ><i class="fa fa-eye"  data-toggle="tooltip" title="Ver Notas" ></i></button>
</td>
