...
@section('title')Gestionar Alumnos @endsection
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            ...
            <a href="{{ route('students.add') }}"><button type="button" class="btn btn-success"  >Agregar Alumno</button></a>
        </div>
